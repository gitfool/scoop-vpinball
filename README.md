...
| [vpinball-mingw-nightly](https://nightly.link/vpinball/vpinball/workflows/vpinball/master?preview) | Visual Pinball BGFX<sup>1</sup> MinGW<sup>2</sup> (nightly<sup>3</sup>) | `scoop install vpinball-mingw-nightly` | [![Version](https://img.shields.io/scoop/v/vpinball-mingw-nightly?bucket=https%3A%2F%2Fgithub.com%2Fgitfool%2Fscoop-vpinball&label=&logo=scoop)](bucket/vpinball-mingw-nightly.json) |
...
<sup>2</sup> [MinGW-w64](https://en.wikipedia.org/wiki/Mingw-w64) for [libwinevbs](https://github.com/vpinball/libwinevbs)

<sup>3</sup> Requires [GitHub](https://github.com) login

<sup>4</sup> Requires [Chrome](https://www.google.com/chrome) browser
